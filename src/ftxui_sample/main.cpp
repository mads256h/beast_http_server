...
// configuration step. It creates a namespace called `beast_http_server`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", beast_http_server::cmake::project_name, beast_http_server::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", beast_http_server::cmake::project_version);
      return EXIT_SUCCESS;
    }
